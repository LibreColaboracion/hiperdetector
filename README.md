...
```
cd existing_repo
git remote add origin https://gitlab.com/MoiRouhs/hiperdetector.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/MoiRouhs/hiperdetector/-/settings/integrations)
